...
const ShiftsTable = () => {
    const [data, setData] = useState([
        { id: 1, name: "Shift A", startTime: "09:00", endTime: "17:00", entryStartTime: "08:30", entryEndTime: "09:00", exitStartTime: "17:00", exitEndTime: "17:30" },
        { id: 2, name: "Shift B", startTime: "13:00", endTime: "21:00", entryStartTime: "12:30", entryEndTime: "13:00", exitStartTime: "21:00", exitEndTime: "21:30" },
    ]);
    ...
    const handleSaveItem = () => {
        if (formMode === "add") {
            const newItem = {
                id: parseInt(formData.ShiftId, 10),
...
>>>>>>> 4914598520def6ba1d3c929b7513f8857ed6740d
        </div>
    );
};
